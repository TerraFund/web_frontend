...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 backdrop-blur-md border-b bg-card/95 border-border text-foreground shadow-lg transition-all duration-300">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <div className="relative">
              <input
                ...
                className="pl-10 pr-4 py-2 rounded-xl border transition-all duration-200 focus:ring-2 focus:ring-primary focus:border-transparent bg-muted border-border text-foreground placeholder-muted-foreground focus:bg-card"
              />
              ...
              <>
                <NotificationDropdown />
                 <div className="relative" ref={userMenuRef}>
                   ...
                   {isUserMenuOpen && (
                      <div className="absolute right-0 mt-2 w-48 rounded-xl shadow-lg border backdrop-blur-md bg-card/95 border-border text-foreground">
                       <div className="py-1">
                          <Link
                            href="/dashboard/profile"
                            className="flex items-center px-4 py-2 text-sm hover:bg-muted text-foreground/80 hover:text-foreground"
                         ...
                         <button
                           onClick={() => {
                            ...
                            className="flex items-center w-full px-4 py-2 text-sm hover:bg-muted text-foreground/80 hover:text-foreground"
                         >
            ...
            <div className="px-4 py-6 space-y-4">
               <div className="relative">
                 <input
                   type="text"
                   placeholder={t('common.search')}
                    className="w-full pl-10 pr-4 py-3 rounded-xl border transition-all duration-200 focus:ring-2 focus:ring-primary focus:border-transparent bg-muted border-border text-foreground placeholder-muted-foreground focus:bg-card"
                 />
